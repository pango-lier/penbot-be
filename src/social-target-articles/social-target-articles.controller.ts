...
export class SocialTargetArticlesController {
  constructor(private readonly socialTargetArticlesService: SocialTargetArticlesService) {}

  @Post()
  create(@Body() createSocialTargetArticleDto: CreateSocialTargetArticleDto) {
    return this.socialTargetArticlesService.create(createSocialTargetArticleDto);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateSocialTargetArticleDto: UpdateSocialTargetArticleDto) {
    return this.socialTargetArticlesService.update(+id, updateSocialTargetArticleDto);
  }
