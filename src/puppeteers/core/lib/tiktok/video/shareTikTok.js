...
const SELECTOR_FACEBOOK = 'span[data-e2e="share-icon"]';
const SELECTOR_FACEBOOK2 = 'span[data-e2e="share-icon"]';
const LINK_FACEBOOK = "https://www.facebook.com/sharer/sharer.php";

const shareTikTok2 = async (page, link) => {
...
module.exports.shareTikTok2 = shareTikTok2
...
module.exports.shareTikTok = shareTikTok